...
HD_PWD='C:/Users/cncai/Desktop/EMSE/AMD/Final_Files/Encryptor_System_IP/Encryptor_System_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encryptor_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encryptor_system.tcl
