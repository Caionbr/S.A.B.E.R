...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ SABER_encryptor_system_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "SABER_encryptor_system_0_0,encryptor_system,{}" *) (* CORE_GENERATION_INFO = "SABER_encryptor_system_0_0,encryptor_system,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=encryptor_system,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "package_project" *) (* X_CORE_INFO = "encryptor_system,Vivado 2024.2" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(go_i, data_i, reset_i, clock_i, data_o, 
  data_valid_o, send_data_o)
/* synthesis syn_black_box black_box_pad_pin="go_i,data_i[7:0],reset_i,data_o[1791:0],data_valid_o,send_data_o" */
