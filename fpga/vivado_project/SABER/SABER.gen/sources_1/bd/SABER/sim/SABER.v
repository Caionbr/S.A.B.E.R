...
//Date        : Thu Aug 21 20:47:16 2025
//Host        : LAPTOP-TDIUQR79 running 64-bit major release  (build 9200)
//Command     : generate_target SABER.bd
//Design      : SABER
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "SABER,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=SABER,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=1,bdsource=USER,da_axi4_cnt=2,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "SABER.hwdef" *) 
module SABER
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [1791:0]encryptor_system_0_data_o;
  wire encryptor_system_0_data_valid_o;
  wire encryptor_system_0_send_data_o;
  ...
  SABER_ADC_8_bits_0_1 ADC_8_bits_0
       (.V_N_i(V_N_i),
        .V_P_i(V_P_i),
        .clock_i(processing_system7_0_FCLK_CLK0),
        .data_o(ADC_8_bits_0_data_o),
        .reset_i(proc_sys_reset_0_peripheral_reset));
  SABER_axi_gpio_0_0 axi_gpio_0
  ...
  SABER_encryptor_system_0_1 encryptor_system_0
       (.clock_i(processing_system7_0_FCLK_CLK0),
        .data_i(ADC_8_bits_0_data_o),
        .data_o(encryptor_system_0_data_o),
        .data_valid_o(encryptor_system_0_data_valid_o),
        .go_i(axi_gpio_0_gpio_io_o),
        .reset_i(axi_gpio_0_gpio2_io_o),
        .send_data_o(encryptor_system_0_send_data_o));
  SABER_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  SABER_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  SABER_wifi_pack_reg_0_0 wifi_pack_reg_0
       (.data_i(encryptor_system_0_data_o),
        .ready_i(encryptor_system_0_data_valid_o),
        ...
        .send_wifi_i(encryptor_system_0_send_data_o));
endmodule
