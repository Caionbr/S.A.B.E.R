...
#
# Script generated by Vivado on Thu Aug 21 20:48:14 +0200 2025
...
#
# Usage        : SABER.sh
#                SABER.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SABER.sh [-reset_run]
#                SABER.sh [-reset_log]
#                SABER.sh [-help]
#
...
export RDI_DATADIR="D:/Programas/Vivado/2024.2/data"
...
# script info
echo -e "SABER.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SABER.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L xlslice_v1_0_4 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L proc_sys_reset_v5_0_16 -L smartconnect_v1_0 -L axi_register_slice_v2_1_33 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SABER xil_defaultlib.SABER xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SABER -key {Behavioral:sim_1:Functional:SABER} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2119.protoinst" -protoinst "protoinst_files/SABER.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Programas/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SABER.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SABER.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SABER.sh [-help]\n\
Usage: SABER.sh [-step]\n\
Usage: SABER.sh [-lib_map_path]\n\
Usage: SABER.sh [-reset_run]\n\
Usage: SABER.sh [-reset_log]\n\
Usage: SABER.sh [-keep_index]\n\
Usage: SABER.sh [-noclean_files]\n\n\
